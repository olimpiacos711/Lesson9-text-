...
var appPath = "C:\\Users\\andre\\OneDrive\\Рабочий стол\\2022-11-16 Моделювання ПЗ Liner\\ConsoleApp1\\ConsoleApp1\\phonebook.csv";
var phonebook = ReadFile(appPath);
//AddPhoneBookRecord(appPath);
phonebook = ReadFile(appPath);
Console.WriteLine("searchcustomer by number");
WorkWithRegex();
...
Console.WriteLine("searchcustomer by firstName/lastName");
WorkWithRegex();

var list2 = SearchCustomer(Console.ReadLine(), phonebook);
var intisdefault2 = 3 == default;
Console.WriteLine(
    $"{(list2.Any() ? $"{string.Join("\r\n", list2)}" : "No customers found")}");
